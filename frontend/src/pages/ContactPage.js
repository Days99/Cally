          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-2">
                <a href="mailto:support@cally.pt" className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300">
                  support@cally.pt
                </a>
              </p>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Response Time</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-2">
                Within 24 hours
              </p>
              <p className="text-sm text-gray-500 dark:text-gray-400">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Global Support</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-2">
                Available worldwide
              </p>
              <p className="text-sm text-gray-500 dark:text-gray-400">
